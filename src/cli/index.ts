...
const logger: Pick<Console, "info" | "warn" | "error"> = {
  info: (str: string) => console.info("[ProtoScript] " + str),
  warn: (str: string) => console.warn("[ProtoScript] " + str),
  error: (str: string) => console.error("[ProtoScript] " + str),
};
...
function getConfig(): Config {
  ...
  const configFilePath = join(projectRoot, ".protoscript.json");
